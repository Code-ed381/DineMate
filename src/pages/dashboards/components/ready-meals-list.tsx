    ...
    <List sx={{ p: 0 }}>
      {readyMeals?.map((dish, index) => (
        <ListItem
          ...
          sx={{
            mb: 2, py: 2.5, px: 2.5, borderRadius: 3, bgcolor: "#e3f2fd", border: "2px solid #1976d2", boxShadow: 2, display: "flex", alignItems: "center", cursor: "pointer", transition: "all 0.3s cubic-bezier(0.4, 0, 0.2, 1)", animation: "readyPulse 2s ease-in-out infinite", "@keyframes readyPulse": { "0%, 100%": { boxShadow: "0 4px 12px rgba(25, 118, 210, 0.3)" }, "50%": { boxShadow: "0 6px 16px rgba(25, 118, 210, 0.5)" } }, "&:hover": { backgroundColor: "#bbdefb", transform: "translateY(-2px)", boxShadow: 4 }
          }}
