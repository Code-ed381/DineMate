...
const ReadyMealsList: React.FC<ReadyMealsListProps> = ({
  readyMeals,
        ...
        <ListItem
          ...
          sx={{
            ...
            "@keyframes readyPulse": {
              "0%, 100%": { boxShadow: "0 4px 12px rgba(25, 118, 210, 0.3)" },
              "50%": { boxShadow: "0 6px 16px rgba(25, 118, 210, 0.5)" },
            },
            "&:hover": {
          ...
          <Box sx={{ flex: 1, minWidth: 0, width: "100%" }}>
            ...
            <Box sx={{ display: "flex", gap: 1, flexWrap: "wrap", mb: 1 }}>
              <Chip
                ...
                size="small"
                sx={{ bgcolor: "#bbdefb", color: "#0d47a1", fontWeight: 500 }}
              />
              <Chip
                label={`Table ${dish?.table_number}`}
                size="small"
                sx={{ bgcolor: "#c5cae9", color: "#283593", fontWeight: 500 }}
              />
              <Chip
                label={
                  dish.course === 1
            ...
            >
              <Box sx={{ display: "flex", alignItems: "center", gap: 0.5 }}>
                ...
                >
                  {formatDateTimeWithSuffix(dish.task_updated_at)}
                </Typography>
              </Box>
              <Typography
                variant="caption"
