    ...
    <List sx={{ p: 0 }}>
      {servedMeals?.map((dish, index) => (
        <ListItem
          key={index}
          sx={{
            mb: 2, py: 2.5, px: 2.5, borderRadius: 3, backgroundColor: "#e8f5e9", border: "1px solid #66bb6a", boxShadow: 1, display: "flex", alignItems: "center", cursor: "default", opacity: 0.9, transition: "all 0.3s cubic-bezier(0.4, 0, 0.2, 1)", "&:hover": { backgroundColor: "#c8e6c9", opacity: 1 }
          }}
        >
